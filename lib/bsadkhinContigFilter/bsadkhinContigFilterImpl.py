...
This sample module contains one small method that filters contigs.
    ...
    def run_bsadkhinContigFilter(self, ctx, params):
        ...
        logging.info('Starting run_bsadkhinContigFilter function. Params=' + pformat(params))
    ...
    def run_bsadkhinContigFilter_max(self, ctx, params):
        """
        :param params: instance of mapping from String to unspecified object
        :returns: instance of type "ReportResults" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        ...
        #BEGIN run_bsadkhinContigFilter_max
        ...
        # if max_length > 999999:
        #     raise ValueError('max_length parameter cannot be greater than 999999')
        #
        ...
        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_bsadkhinContigFilter_max return value ' +
                             'output is not type dict as required.')

        #END run_bsadkhinContigFilter_max
